...
def multiprocessing_training(index):
    ...
    class Project:
        ...
        def rewrite_and_make_folder(self):
            ...
            if self.rank_start:
                algorithm_matrix_path = model_matrix_path + "/Rank_delay"
            elif self.edge_max_start:
                algorithm_matrix_path = model_matrix_path + "/Edge_max_delay"
            elif self.priority_start:
                algorithm_matrix_path = model_matrix_path + "Priority_delay"
            elif self.weighted_start:
                weighted_matrix_path = model_matrix_path + "/Weighted_delay"
                ...
                algorithm_matrix_path = model_matrix_path + "/PF_delay"
