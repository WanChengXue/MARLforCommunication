...
def compare_capacity(user_number, velocity):
    ...
    # GA_path= pathlib.Path("../data_part/Greedy_result")/(user_number+'_'+velocity)/"GA_sum_SE.npy"
    ...
    # GA_scheduling_path = pathlib.Path("../data_part/Greedy_result")/(user_number+'_'+velocity)/"GA_shceduling_sequence.npy"
