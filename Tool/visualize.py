...
def compare_capacity(user_number, velocity):
    ...
    infer_path = pathlib.Path("./Exp/Pointer_network_folder/Max_SE/Sharing_result/")/(user_number+'_'+velocity)/"infer_SE.npy"
    ablation_infer_path = pathlib.Path("./Exp/Pointer_network_folder/Max_SE/Ablation_sharing_result/")/(user_number+'_'+velocity)/"infer_SE.npy"
    plt.figure()
